...
CREATE TABLE tbl_melhores (
	ranking INT NOT NULL,
	empréstimo INT NOT NULL,
	obras VARCHAR (220) NOT NULL,
	autores VARCHAR (80) NOT NULL,
	público VARCHAR (15) NOT NULL,

)


CREATE PROCEDURE inserir_livros AS BEGIN

	INSERT INTO tbl_melhores (ranking, empréstimo, obras, autores, público) VALUES
		...
		(81, 106, 'Jogos Vorazes', 'Suzanne Coullins', 'infantojuvenil'),
		(82, 105, 'P.S: Ainda amo você', 'Jenni han', 'adulto'),
		(83, 104, '1808: Como uma rainha louca, um príncipe medroso e uma corte corrupita enganaram Napoleão e mudaram a história de Portugal e do Brasil', 'Laurentino Gomes', 'adulto'),
		...
		(89, 101, 'Harry Poter e o enigma do príncipe', 'J. K Rowling', 'infantojuvenil'),
		(90, 101, 'Mais lindo que a lua', 'Julia Queen', 'adulto'),
		(91, 101, 'nove noites: Romance', 'Bernado Carvalho', 'adulto'),
		(92, 100, 'Ainda sou eu', 'Jojo Moyes', 'adulto'),
		(93, 99, 'Desventuras de um garoto nada comum, livro 1: o herói do armário', 'rachel Reéne Russell; Nikk Russell; Erin Russel', 'infantojuvenil'),
		(94, 97, 'Mais forte que o sol', 'Julia Queen', 'adulto'),
		(95, 95, 'A rainha vermelha', 'Victória Aveyard', 'infantojuvenil'),
		(96, 95, 'Desventuras de um garoto nada comum, livro 2: Caos no colégio', 'Rachel Renne Russell', 'infantojuvenil'),
		...
		(100, 94, 'Deixada pra trás', 'Charlie Donlea', 'adulto');
END
